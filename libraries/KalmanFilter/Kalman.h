...
//        Q_angle = 0.01 * 57;  very good
//       Q_bias = 0.008 * 57;  // dec2inc rise time 
//       R_measure = 0.05;     // dec2dec overshoot 
        ...
        bias = 0; // Reset bias
        P[0][0] = 1; // Since we assume tha the bias is 0 and we know the starting angle (use setAngle), the error covariance matrix is set like so - see: http://en.wikipedia.org/wiki/Kalman_filter#Example_application.2C_technical
        P[0][1] = 0;
        P[1][0] = 0;
        P[1][1] = 1;
    };
