...
//const unsigned char adc_cmd[9]= { 0x87, 0x97, 0xA7, 0xB7, 0xC7, 0xD7, 0xE7, 0xF7, 0x00 };
const unsigned char adc_cmd[9]=  { 0x87, 0xC7, 0x97, 0xD7, 0xA7, 0xE7, 0xB7, 0xF7, 0x00 };
volatile long adc_value[8], last_adc[8];
...
int APM_ADC_Class::Ch(unsigned char ch_num)
{
  ...
  if (adc_counter[ch_num]>0){
    ...
    last_adc[ch_num] = result;
  }
  else
    result = last_adc[ch_num];
